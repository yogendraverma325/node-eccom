    ...
    for (let i = 0; i < maxRows; i++) {
      ...
      rows += `
        <tr>
            ...
            <td>${earning.fixedPayElementAmount && earning.fixedPayElementAmount > 0
...
const sendWeeklyTask = async (data) => {
  let headerContent = ''
  for (const element of data.tasks) {
    let innerContent = ''
    element.items.forEach((item) => (innerContent += `<li style="padding:0px 0 10px 0;line-height:18px;font-size:13px;color:#444">${item}</li>`))
    headerContent += `<p> <span style="font-family:Calibri;font-size:14px">${element.header} - <b>${element.subject}</b></span>
    <ul>
      ${innerContent}
    </ul>
    </p>`
													...
													<table
														...
														<tbody>
															<tr>
																<td>
																	<p>
																		<span style="font-family:Calibri;font-size:14px">Hello </span>
																		<span style="font-family:Calibri;font-size:14px">${data.name}</span>
																		<span style="font-family:Calibri;font-size:14px">,</span><br><br>
																		<span style="font-family:Calibri;font-size:14px">Here are the pending tasks/requests that need to be approved from your end.</span><br><br>
																	</p>
                                  ${headerContent}
																</td>
															</tr>
